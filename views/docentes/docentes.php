...
<div class="container text-center">
    ...
    <div class="row justify-items-center mb-3">
        <div class="col-md-2 offset-10">
            <a href="registro-docentes.php" class="btn btn-success"><b><i class="fa-solid fa-plus"></i> Agregar</b></a>
        </div>
    </div>
    ...
    function eliminarDocente(idDocente) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                var url = "../../controller/docentes/eliminar-docente.php?id="+idDocente;
                $.ajax({
                    type: 'POST',
                    url: url,
                    async: true,
